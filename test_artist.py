...
if __name__ == "__main__":
    ...
    print(AlbumWrapper.artist_singles(artist))
    print(AlbumWrapper.artist_name(artist))
    print(AlbumWrapper.artist_critic_score(artist))
    print(AlbumWrapper.artist_user_score(artist))
    print(AlbumWrapper.artist_total_score(artist))
    print(AlbumWrapper.artist_follower_count(artist))
    print(AlbumWrapper.artist_details(artist))
    print(AlbumWrapper.artist_top_songs(artist))
    print(AlbumWrapper.similar_artists(artist))
